 ...
 */
class ArticleDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ArticleDto';
    ...
    protected static $openAPITypes = [
        ...
        'model' => 'string',
        'isSerialNumberActive' => 'bool',
        'isSerialNumberOnlyForHistory' => 'bool',
        'isLottoSerialNumber' => 'bool',
        'createSerialNumberType' => '\OpenAPI\Client\Radix\Model\CreateSntype',
        'serialNumberPrefix' => 'string',
        'articleType' => '\OpenAPI\Client\Radix\Model\Articletype',
        'producer' => '\OpenAPI\Client\Radix\Model\IdCode',
        'inactive' => 'bool',
        'blocked' => '\DateTime',
        'isDiscontinued' => 'bool',
        'isStockMovementActive' => 'bool',
        ...
        'intrastatGroup' => '\OpenAPI\Client\Radix\Model\IdCode',
        ...
        'availabilityControl' => '\OpenAPI\Client\Radix\Model\AvailabilityControlType',
        'descriptions' => '\OpenAPI\Client\Radix\Model\Description[]',
        'additionalfields' => '\OpenAPI\Client\Radix\Model\AdditionalFieldDto[]',
        'classifications' => '\OpenAPI\Client\Radix\Model\ClassificationDto[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'model' => null,
        'isSerialNumberActive' => null,
        'isSerialNumberOnlyForHistory' => null,
        'isLottoSerialNumber' => null,
        'createSerialNumberType' => null,
    ...
    protected static array $openAPINullables = [
        ...
        'isSerialNumberOnlyForHistory' => false,
        'isLottoSerialNumber' => false,
        'createSerialNumberType' => false,
        ...
        'isStockMovementActive' => false,
        'warrantyCustomer' => false,
        'warrantyProducer' => false,
        'minimumOrderQuantitySales' => false,
        'intrastatTypeOfMovement' => false,
        'intrastatOriginCountry' => true,
        'intrastatGroup' => false,
        'intrastatConversion' => false,
    ...
    protected static $attributeMap = [
        ...
        'model' => 'model',
        'isSerialNumberActive' => 'isSerialNumberActive',
        'isSerialNumberOnlyForHistory' => 'isSerialNumberOnlyForHistory',
        'isLottoSerialNumber' => 'isLottoSerialNumber',
        'createSerialNumberType' => 'createSerialNumberType',
        ...
        'isStockMovementActive' => 'isStockMovementActive',
    ...
    protected static $setters = [
        ...
        'model' => 'setModel',
        'isSerialNumberActive' => 'setIsSerialNumberActive',
        'isSerialNumberOnlyForHistory' => 'setIsSerialNumberOnlyForHistory',
        'isLottoSerialNumber' => 'setIsLottoSerialNumber',
        'createSerialNumberType' => 'setCreateSerialNumberType',
        'serialNumberPrefix' => 'setSerialNumberPrefix',
        'articleType' => 'setArticleType',
        'producer' => 'setProducer',
        'inactive' => 'setInactive',
        'blocked' => 'setBlocked',
        'isDiscontinued' => 'setIsDiscontinued',
        'isStockMovementActive' => 'setIsStockMovementActive',
        ...
        'availabilityControl' => 'setAvailabilityControl',
    ...
    protected static $getters = [
        ...
        'model' => 'getModel',
        'isSerialNumberActive' => 'getIsSerialNumberActive',
        'isSerialNumberOnlyForHistory' => 'getIsSerialNumberOnlyForHistory',
        'isLottoSerialNumber' => 'getIsLottoSerialNumber',
        'createSerialNumberType' => 'getCreateSerialNumberType',
        'serialNumberPrefix' => 'getSerialNumberPrefix',
        'articleType' => 'getArticleType',
        'producer' => 'getProducer',
        'inactive' => 'getInactive',
        'blocked' => 'getBlocked',
        'isDiscontinued' => 'getIsDiscontinued',
        'isStockMovementActive' => 'getIsStockMovementActive',
        ...
        'availabilityControl' => 'getAvailabilityControl',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('isSerialNumberActive', $data ?? [], null);
        $this->setIfExists('isSerialNumberOnlyForHistory', $data ?? [], null);
        $this->setIfExists('isLottoSerialNumber', $data ?? [], null);
        $this->setIfExists('createSerialNumberType', $data ?? [], null);
        $this->setIfExists('serialNumberPrefix', $data ?? [], null);
        $this->setIfExists('articleType', $data ?? [], null);
        ...
        $this->setIfExists('isStockMovementActive', $data ?? [], null);
        ...
        $this->setIfExists('availabilityControl', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets isSerialNumberActive
     *
     * @return bool|null
     */
    public function getIsSerialNumberActive()
    {
        return $this->container['isSerialNumberActive'];
    }

    /**
     * Sets isSerialNumberActive
     *
     * @param bool|null $isSerialNumberActive isSerialNumberActive
     *
     * @return self
     */
    public function setIsSerialNumberActive($isSerialNumberActive)
    {
        if (is_null($isSerialNumberActive)) {
            throw new \InvalidArgumentException('non-nullable isSerialNumberActive cannot be null');
        }
        $this->container['isSerialNumberActive'] = $isSerialNumberActive;

        return $this;
    }

    /**
     * Gets isSerialNumberOnlyForHistory
     *
     * @return bool|null
     */
    public function getIsSerialNumberOnlyForHistory()
    {
        return $this->container['isSerialNumberOnlyForHistory'];
    }

    /**
     * Sets isSerialNumberOnlyForHistory
     *
     * @param bool|null $isSerialNumberOnlyForHistory isSerialNumberOnlyForHistory
     *
     * @return self
     */
    public function setIsSerialNumberOnlyForHistory($isSerialNumberOnlyForHistory)
    {
        if (is_null($isSerialNumberOnlyForHistory)) {
            throw new \InvalidArgumentException('non-nullable isSerialNumberOnlyForHistory cannot be null');
        }
        $this->container['isSerialNumberOnlyForHistory'] = $isSerialNumberOnlyForHistory;

        return $this;
    }

    /**
     * Gets isLottoSerialNumber
     *
     * @return bool|null
     */
    public function getIsLottoSerialNumber()
    {
        return $this->container['isLottoSerialNumber'];
    }

    /**
     * Sets isLottoSerialNumber
     *
     * @param bool|null $isLottoSerialNumber isLottoSerialNumber
     *
     * @return self
     */
    public function setIsLottoSerialNumber($isLottoSerialNumber)
    {
        if (is_null($isLottoSerialNumber)) {
            throw new \InvalidArgumentException('non-nullable isLottoSerialNumber cannot be null');
        }
        $this->container['isLottoSerialNumber'] = $isLottoSerialNumber;

        return $this;
    }

    /**
     * Gets createSerialNumberType
     *
     * @return \OpenAPI\Client\Radix\Model\CreateSntype|null
     */
    public function getCreateSerialNumberType()
    {
        return $this->container['createSerialNumberType'];
    }

    /**
     * Sets createSerialNumberType
     *
     * @param \OpenAPI\Client\Radix\Model\CreateSntype|null $createSerialNumberType createSerialNumberType
     *
     * @return self
     */
    public function setCreateSerialNumberType($createSerialNumberType)
    {
        if (is_null($createSerialNumberType)) {
            throw new \InvalidArgumentException('non-nullable createSerialNumberType cannot be null');
        }
        $this->container['createSerialNumberType'] = $createSerialNumberType;

        return $this;
    }

    /**
     * Gets serialNumberPrefix
     *
     * @return string|null
     */
    public function getSerialNumberPrefix()
    {
        return $this->container['serialNumberPrefix'];
    }

    /**
     * Sets serialNumberPrefix
     *
     * @param string|null $serialNumberPrefix serialNumberPrefix
     *
     * @return self
     */
    public function setSerialNumberPrefix($serialNumberPrefix)
    {
        if (is_null($serialNumberPrefix)) {
            array_push($this->openAPINullablesSetToNull, 'serialNumberPrefix');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('serialNumberPrefix', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['serialNumberPrefix'] = $serialNumberPrefix;
     ...
     * Gets articleType
     *
     * @return \OpenAPI\Client\Radix\Model\Articletype|null
     */
    public function getArticleType()
    {
        return $this->container['articleType'];
    }

    /**
     * Sets articleType
     *
     * @param \OpenAPI\Client\Radix\Model\Articletype|null $articleType articleType
     *
     * @return self
     */
    ...
    public function setIsDiscontinued($isDiscontinued)
    {
        if (is_null($isDiscontinued)) {
            throw new \InvalidArgumentException('non-nullable isDiscontinued cannot be null');
        }
    ...
    /**
     * Gets isStockMovementActive
     *
     * @return bool|null
     */
    public function getIsStockMovementActive()
    {
        return $this->container['isStockMovementActive'];
    }

    /**
     * Sets isStockMovementActive
     *
     * @param bool|null $isStockMovementActive isStockMovementActive
     *
     * @return self
     */
    public function setIsStockMovementActive($isStockMovementActive)
    {
        if (is_null($isStockMovementActive)) {
            throw new \InvalidArgumentException('non-nullable isStockMovementActive cannot be null');
        }
        $this->container['isStockMovementActive'] = $isStockMovementActive;
    ...
    public function setMinimumOrderQuantitySales($minimumOrderQuantitySales)
    {
        if (is_null($minimumOrderQuantitySales)) {
            throw new \InvalidArgumentException('non-nullable minimumOrderQuantitySales cannot be null');
        }
     ...
     * Sets intrastatGroup
     *
     * @param \OpenAPI\Client\Radix\Model\IdCode|null $intrastatGroup intrastatGroup
     *
     * @return self
     */
    public function setIntrastatGroup($intrastatGroup)
    {
        if (is_null($intrastatGroup)) {
            throw new \InvalidArgumentException('non-nullable intrastatGroup cannot be null');
        }
    ...
    public function setIntrastatConversion($intrastatConversion)
    {
        if (is_null($intrastatConversion)) {
            throw new \InvalidArgumentException('non-nullable intrastatConversion cannot be null');
        }
    ...
    /**
     * Gets availabilityControl
     *
     * @return \OpenAPI\Client\Radix\Model\AvailabilityControlType|null
     */
    public function getAvailabilityControl()
    {
        return $this->container['availabilityControl'];
    }

    /**
     * Sets availabilityControl
     *
     * @param \OpenAPI\Client\Radix\Model\AvailabilityControlType|null $availabilityControl availabilityControl
     *
     * @return self
     */
    public function setAvailabilityControl($availabilityControl)
    {
        if (is_null($availabilityControl)) {
            throw new \InvalidArgumentException('non-nullable availabilityControl cannot be null');
        }
        $this->container['availabilityControl'] = $availabilityControl;
     ...
     *
     * @return \OpenAPI\Client\Radix\Model\AdditionalFieldDto[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Radix\Model\AdditionalFieldDto[]|null $additionalfields additionalfields
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Radix\Model\ClassificationDto[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Radix\Model\ClassificationDto[]|null $classifications classifications
     *
     * @return self
     */
