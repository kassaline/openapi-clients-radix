...
/**
 * ExtendedLoginApiKeyRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class ExtendedLoginApiKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExtendedLoginApiKeyRequest';
    ...
    */
    ...
    public function setApiKey($apiKey)
    {
        ...
        if ((mb_strlen($apiKey) < 1)) {
            throw new \InvalidArgumentException('invalid length for $apiKey when calling ExtendedLoginApiKeyRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets licenseId
     *
     * @param string|null $licenseId licenseId
     *
     * @return self
     */
    public function setLicenseId($licenseId)
    {
        if (is_null($licenseId)) {
            array_push($this->openAPINullablesSetToNull, 'licenseId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('licenseId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
