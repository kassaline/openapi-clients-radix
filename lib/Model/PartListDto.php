 ...
 */
class PartListDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartListDto';
    ...
    protected static $openAPITypes = [
        ...
        'blocked' => '\DateTime',
        'inactive' => 'bool',
        'details' => '\OpenAPI\Client\Radix\Model\PartListDetailDto[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('mainVariant', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['mainVariant'];
    }

    /**
     * Sets mainVariant
     *
     * @param bool|null $mainVariant mainVariant
     *
     * @return self
     */
    public function setMainVariant($mainVariant)
    {
        if (is_null($mainVariant)) {
            throw new \InvalidArgumentException('non-nullable mainVariant cannot be null');
        }
        $this->container['mainVariant'] = $mainVariant;
    ...
    public function setCalculatePricePerPartList($calculatePricePerPartList)
    {
        if (is_null($calculatePricePerPartList)) {
            throw new \InvalidArgumentException('non-nullable calculatePricePerPartList cannot be null');
        }
    ...
    public function setExecuteExplosingForMacroTemplate($executeExplosingForMacroTemplate)
    {
        if (is_null($executeExplosingForMacroTemplate)) {
            throw new \InvalidArgumentException('non-nullable executeExplosingForMacroTemplate cannot be null');
        }
     ...
     * Gets details
     *
     * @return \OpenAPI\Client\Radix\Model\PartListDetailDto[]|null
     */
     ...
     * Sets details
     *
     * @param \OpenAPI\Client\Radix\Model\PartListDetailDto[]|null $details details
     *
     * @return self
     */
