...
/**
 * IsoVatnumber Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class IsoVatnumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'IsoVatnumber';
    ...
    */
     ...
     * Sets isocode
     *
     * @param string|null $isocode isocode
     *
     * @return self
     */
    ...
    {
        if (is_null($isocode)) {
            array_push($this->openAPINullablesSetToNull, 'isocode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('isocode', $nullablesSetToNull);
            if ($index !== FALSE) {
