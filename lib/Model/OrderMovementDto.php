...
/**
 * OrderMovementDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class OrderMovementDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'OrderMovementDto';
    ...
    protected static $openAPITypes = [
        ...
        'state' => '\OpenAPI\Client\Radix\Model\DocumentStateType',
        'comment' => 'string',
        'print' => 'bool',
        'printPrice' => 'bool',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('deliveredQuantity', $data ?? [], null);
    ...
    */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Radix\Model\DocumentStateType|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Radix\Model\DocumentStateType|null $state state
     *
     * @return self
     */
     ...
     *
     * @param float|null $deliveredQuantity deliveredQuantity
     *
     * @return self
     */
    public function setDeliveredQuantity($deliveredQuantity)
    {
        if (is_null($deliveredQuantity)) {
            throw new \InvalidArgumentException('non-nullable deliveredQuantity cannot be null');
        }
