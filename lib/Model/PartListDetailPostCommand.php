...
/**
 * PartListDetailPostCommand Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class PartListDetailPostCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartListDetailPostCommand';
    ...
    {
        $this->setIfExists('partListId', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getPartListId()
    {
        return $this->container['partListId'];
    }

    /**
     * Sets partListId
     *
     * @param string|null $partListId partListId
     *
     * @return self
     */
    public function setPartListId($partListId)
    {
        if (is_null($partListId)) {
            array_push($this->openAPINullablesSetToNull, 'partListId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('partListId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['partListId'] = $partListId;
