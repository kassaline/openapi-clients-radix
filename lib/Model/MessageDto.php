...
class MessageDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('descriptionHtml', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $descriptionHtml descriptionHtml
     *
     * @return self
     */
    public function setDescriptionHtml($descriptionHtml)
    {
        if (is_null($descriptionHtml)) {
            array_push($this->openAPINullablesSetToNull, 'descriptionHtml');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('descriptionHtml', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
