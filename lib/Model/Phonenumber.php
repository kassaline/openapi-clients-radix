...
class Phonenumber implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => '\OpenAPI\Client\Radix\Model\Phonenumbertyp',
        'number' => 'string',
        'description' => 'string'
    ];
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Radix\Model\Phonenumbertyp|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Radix\Model\Phonenumbertyp|null $type type
     *
     * @return self
     */
