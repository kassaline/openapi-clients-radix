...
/**
 * LoginApiKeyRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class LoginApiKeyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoginApiKeyRequest';
    ...
    */
    ...
    public function setApiKey($apiKey)
    {
        ...
        if ((mb_strlen($apiKey) < 1)) {
            throw new \InvalidArgumentException('invalid length for $apiKey when calling LoginApiKeyRequest., must be bigger than or equal to 1.');
        }
