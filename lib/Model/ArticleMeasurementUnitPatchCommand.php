...
/**
 * ArticleMeasurementUnitPatchCommand Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class ArticleMeasurementUnitPatchCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ArticleMeasurementUnitPatchCommand';
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\OpenAPI\Client\Radix\Model\MeasurementUnittype',
        'conversation' => 'float',
        'netWeight' => 'float',
        'id' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('netWeight', $data ?? [], null);
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Radix\Model\MeasurementUnittype|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Radix\Model\MeasurementUnittype|null $type type
     *
     * @return self
     */
     ...
     * Sets conversation
     *
     * @param float|null $conversation conversation
     *
     * @return self
     */
     ...
     * Sets netWeight
     *
     * @param float|null $netWeight netWeight
     *
     * @return self
     */
    public function setNetWeight($netWeight)
    {
        if (is_null($netWeight)) {
            array_push($this->openAPINullablesSetToNull, 'netWeight');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('netWeight', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
