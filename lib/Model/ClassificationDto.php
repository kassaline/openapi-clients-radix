...
/**
 * ClassificationDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class ClassificationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ClassificationDto';
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\OpenAPI\Client\Radix\Model\ClassificationFkType',
    ...
    protected static $setters = [
        ...
        'classificationCode' => 'setClassificationCode',
        'classificationDescription' => 'setClassificationDescription'
    ];
    ...
    protected static $getters = [
        ...
        'classificationDescription' => 'getClassificationDescription'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('classificationId', $data ?? [], null);
        $this->setIfExists('classificationCode', $data ?? [], null);
        $this->setIfExists('classificationDescription', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Radix\Model\ClassificationFkType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Radix\Model\ClassificationFkType|null $type type
     *
     * @return self
     */
     ...
     *
     * @param string|null $classificationId classificationId
     *
     * @return self
     */
    public function setClassificationId($classificationId)
    {
        if (is_null($classificationId)) {
            array_push($this->openAPINullablesSetToNull, 'classificationId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('classificationId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets classificationCode
     *
     * @return string|null
     */
    public function getClassificationCode()
    {
        return $this->container['classificationCode'];
    }

    /**
     * Sets classificationCode
     *
     * @param string|null $classificationCode classificationCode
     *
     * @return self
     */
    public function setClassificationCode($classificationCode)
    {
        if (is_null($classificationCode)) {
            array_push($this->openAPINullablesSetToNull, 'classificationCode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('classificationCode', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['classificationCode'] = $classificationCode;

        return $this;
    }

    /**
     * Gets classificationDescription
     *
     * @return string|null
     */
    public function getClassificationDescription()
    {
        return $this->container['classificationDescription'];
    }

    /**
     * Sets classificationDescription
     *
     * @param string|null $classificationDescription classificationDescription
     *
     * @return self
     */
    public function setClassificationDescription($classificationDescription)
    {
        if (is_null($classificationDescription)) {
            array_push($this->openAPINullablesSetToNull, 'classificationDescription');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('classificationDescription', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['classificationDescription'] = $classificationDescription;
