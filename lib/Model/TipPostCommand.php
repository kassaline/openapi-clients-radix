...
/**
 * TipPostCommand Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class TipPostCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TipPostCommand';
    ...
    protected static $openAPITypes = [
        ...
        'type' => '\OpenAPI\Client\Radix\Model\TipType',
        'masterId' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('masterId', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Radix\Model\TipType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Radix\Model\TipType|null $type type
     *
     * @return self
     */
     ...
     * Sets masterId
     *
     * @param string|null $masterId masterId
     *
     * @return self
     */
    ...
    {
        if (is_null($masterId)) {
            array_push($this->openAPINullablesSetToNull, 'masterId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('masterId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
