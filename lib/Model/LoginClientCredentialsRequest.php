...
/**
 * LoginClientCredentialsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class LoginClientCredentialsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoginClientCredentialsRequest';
    ...
    */
    ...
    public function setClientId($clientId)
    {
        ...
        if ((mb_strlen($clientId) < 1)) {
            throw new \InvalidArgumentException('invalid length for $clientId when calling LoginClientCredentialsRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setClientSecret($clientSecret)
    {
        ...
        if ((mb_strlen($clientSecret) < 1)) {
            throw new \InvalidArgumentException('invalid length for $clientSecret when calling LoginClientCredentialsRequest., must be bigger than or equal to 1.');
        }
