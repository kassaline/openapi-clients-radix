...
class CustomerDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'agent3' => '\OpenAPI\Client\Radix\Model\IdCodeDescription',
        'agent4' => '\OpenAPI\Client\Radix\Model\IdCodeDescription',
        'agent5' => '\OpenAPI\Client\Radix\Model\IdCodeDescription',
        'currency' => 'string',
        ...
        'firstname' => 'string',
        'surname' => 'string',
        'fidoCheck' => '\OpenAPI\Client\Radix\Model\FidoCheckType',
        'fidoCheckInfo' => 'string',
        ...
        'companyGroup' => '\OpenAPI\Client\Radix\Model\IdCodeDescription',
    ...
    protected static array $openAPINullables = [
        ...
        'displayLineDiscounts' => false,
        'createDeliveryNoteBlocked' => false,
        'user' => false,
        'inactive' => false,
        'lockedSince' => true,
        'createDate' => true,
        ...
        'companyGroup' => false,
        'bank' => false,
        'createOfferBlocked' => false,
        'createOrderBlocked' => false,
        'createInvoiceBlocked' => false,
        'createTicketBlocked' => false,
        'createPackingListBlocked' => false,
        'createCashReceiptBlocked' => false,
    ...
    protected static $setters = [
        ...
        'surname' => 'setSurname',
        'fidoCheck' => 'setFidoCheck',
        'fidoCheckInfo' => 'setFidoCheckInfo',
    ...
    protected static $getters = [
        ...
        'surname' => 'getSurname',
        'fidoCheck' => 'getFidoCheck',
        'fidoCheckInfo' => 'getFidoCheckInfo',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fidoCheck', $data ?? [], null);
        $this->setIfExists('fidoCheckInfo', $data ?? [], null);
        ...
        $this->setIfExists('companyGroup', $data ?? [], null);
    ...
    */
     ...
     * Sets agent3
     *
     * @param \OpenAPI\Client\Radix\Model\IdCodeDescription|null $agent3 agent3
     *
     * @return self
     */
     ...
     * Sets agent4
     *
     * @param \OpenAPI\Client\Radix\Model\IdCodeDescription|null $agent4 agent4
     *
     * @return self
     */
     ...
     * Sets agent5
     *
     * @param \OpenAPI\Client\Radix\Model\IdCodeDescription|null $agent5 agent5
     *
     * @return self
     */
     ...
     * Gets fidoCheck
     *
     * @return \OpenAPI\Client\Radix\Model\FidoCheckType|null
     */
    public function getFidoCheck()
    {
        return $this->container['fidoCheck'];
    }

    /**
     * Sets fidoCheck
     *
     * @param \OpenAPI\Client\Radix\Model\FidoCheckType|null $fidoCheck fidoCheck
     *
     * @return self
     */
    public function setFidoCheck($fidoCheck)
    {
        if (is_null($fidoCheck)) {
            throw new \InvalidArgumentException('non-nullable fidoCheck cannot be null');
        }
        $this->container['fidoCheck'] = $fidoCheck;
     ...
     * @return string|null
     */
    public function getFidoCheckInfo()
    {
        return $this->container['fidoCheckInfo'];
    }

    /**
     * Sets fidoCheckInfo
     *
     * @param string|null $fidoCheckInfo fidoCheckInfo
     *
     * @return self
     */
    public function setFidoCheckInfo($fidoCheckInfo)
    {
        if (is_null($fidoCheckInfo)) {
            array_push($this->openAPINullablesSetToNull, 'fidoCheckInfo');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fidoCheckInfo', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['fidoCheckInfo'] = $fidoCheckInfo;
    ...
    public function setDisplayLineDiscounts($displayLineDiscounts)
    {
        if (is_null($displayLineDiscounts)) {
            throw new \InvalidArgumentException('non-nullable displayLineDiscounts cannot be null');
        }
    ...
    public function setCreateDeliveryNoteBlocked($createDeliveryNoteBlocked)
    {
        if (is_null($createDeliveryNoteBlocked)) {
            throw new \InvalidArgumentException('non-nullable createDeliveryNoteBlocked cannot be null');
        }
    ...
    public function setReverseCharge($reverseCharge)
    {
        if (is_null($reverseCharge)) {
            throw new \InvalidArgumentException('non-nullable reverseCharge cannot be null');
        }
    ...
    {
        return $this->container['companyGroup'];
    }

    /**
     * Sets companyGroup
     *
     * @param \OpenAPI\Client\Radix\Model\IdCodeDescription|null $companyGroup companyGroup
     *
     * @return self
     */
    public function setCompanyGroup($companyGroup)
    {
        if (is_null($companyGroup)) {
            throw new \InvalidArgumentException('non-nullable companyGroup cannot be null');
        }
        $this->container['companyGroup'] = $companyGroup;
    ...
    public function setCreateOfferBlocked($createOfferBlocked)
    {
        if (is_null($createOfferBlocked)) {
            throw new \InvalidArgumentException('non-nullable createOfferBlocked cannot be null');
        }
    ...
    public function setCreateOrderBlocked($createOrderBlocked)
    {
        if (is_null($createOrderBlocked)) {
            throw new \InvalidArgumentException('non-nullable createOrderBlocked cannot be null');
        }
    ...
    public function setCreateInvoiceBlocked($createInvoiceBlocked)
    {
        if (is_null($createInvoiceBlocked)) {
            throw new \InvalidArgumentException('non-nullable createInvoiceBlocked cannot be null');
        }
    ...
    public function setCreateTicketBlocked($createTicketBlocked)
    {
        if (is_null($createTicketBlocked)) {
            throw new \InvalidArgumentException('non-nullable createTicketBlocked cannot be null');
        }
    ...
    public function setCreatePackingListBlocked($createPackingListBlocked)
    {
        if (is_null($createPackingListBlocked)) {
            throw new \InvalidArgumentException('non-nullable createPackingListBlocked cannot be null');
        }
    ...
    public function setCreateCashReceiptBlocked($createCashReceiptBlocked)
    {
        if (is_null($createCashReceiptBlocked)) {
            throw new \InvalidArgumentException('non-nullable createCashReceiptBlocked cannot be null');
        }
    ...
    public function setPriceIncludingVat($priceIncludingVat)
    {
        if (is_null($priceIncludingVat)) {
            throw new \InvalidArgumentException('non-nullable priceIncludingVat cannot be null');
        }
