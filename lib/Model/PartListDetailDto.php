...
/**
 * PartListDetailDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client\Radix
 * @author   OpenAPI Generator team
 ...
 */
class PartListDetailDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartListDetailDto';
    ...
    protected static array $openAPINullables = [
        ...
        'quantity' => false,
        'unitOfMeasure' => true,
        'conversionFactorQuantity' => false
    ];
    ...
    */
    ...
    public function setConversionFactorQuantity($conversionFactorQuantity)
    {
        if (is_null($conversionFactorQuantity)) {
            throw new \InvalidArgumentException('non-nullable conversionFactorQuantity cannot be null');
        }
